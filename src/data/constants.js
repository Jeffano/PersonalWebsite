...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/10UrBw6tPILB96eYPWFB1NYDRmdIHr70a/view?usp=sharing",
...
export const experiences = [
  ...
  },
  {
    ...
    desc: "Utilized the Point of Sale (POS) system to enable seamless payments via credit, debit, and gift cards, while also powering an event ticketing app and online parking payment solutions. • Led settlement processes by creating customized merchant settlement files, ensuring accurate transaction categorization and mapping.\n• Developed a robust communication framework for transmitting settlement files to acquiring institutions and monitoring real-time status updates.\n• Utilized database expertise to update transaction statuses based on acquiring institution feedback, maintaining accurate records.\n• Achieved a 30% increase in payment processing efficiency and a 20% reduction in settlement processing time through integration and acknowledgment system enhancements.\n• Collaborated with cross-functional teams to overcome technical challenges and enhance data accuracy, fostering a culture of innovation and collaboration.",
    skills: [
      "Java",
      "Postman API",
      "OAuth",
  ...
  },
  {
    ...
    desc: "Elevated student performance by providing personalized instruction to over 20 individuals, fostering knowledge expansion and addressing individual concerns. • Implemented engaging activities that enhanced learning outcomes and fostered positive, safe conduct in both online and in-person settings. • Advocated for educators, resulting in a 40% reduction of workload through effective student record management and tailored lesson planning. • Delivered instruction using a combination of presentations, hands-on demonstrations, and other educational tools in both virtual and physical settings",
    skills: [
      "Leadership",
      "Mathematics",
      "Teaching",
